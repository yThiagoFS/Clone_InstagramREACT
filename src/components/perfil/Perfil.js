    ...
    return (
        ...
        <div className="wrapper__profile">
            <div className="wrapper__contentProfile">
                ...
                <div class="container__profileContent">
                    <div className="wrapper__profileFirst">
                        <h1 className="name">jaiminho_carteiro</h1>
                    ...
                    <div className="wrapper__profileThird">
                        <ul>
                            <li><strong>Jaiminho</strong></li>
                            <li>Tangamandápio</li>
                            <li>72 Anos</li>
                            <li>"Eu prefiro evitar a fadiga."</li>
            ...
            <div className="destaque">
                <div className="foto"><img src="https://media-cdn.tripadvisor.com/media/photo-s/1a/7b/86/eb/dreams-acapulco-resort.jpg" width={80} height={80} />
                <span>Acapulco</span></div>
                <div className="foto"><img src="https://feriasbrasil.com.br/especial/2018-01-15/castelhanos.jpg" width={80} height={80} />
                <span>litoral</span></div>
                <div className="foto"><img src="https://i.pinimg.com/736x/c6/5f/7e/c65f7e2870bbd1f521f944e569ee3342.jpg" width={80} height={80} />
                <span>Tangamandápio</span></div>
                <div className="foto"><img src="https://www.segurospromo.com.br/blog/wp-content/uploads/2020/11/cidade-de-liverpool-capa.jpg" width={80} height={80} />
                <span>Liverpool</span></div>
                <div className="foto"><img src="https://certificadas.gptw.com.br/images/profiles/instituto-proa/company_logo.jpg" width={80} height={80} />
                <span>PROA</span></div>
            ...
            <div className="postagem">
                <div className="photo"><img src="https://www.melhoresdestinos.com.br/wp-content/uploads/2019/07/asa-aviao-capa2019-06-820x430.jpg" width={300} height={300}/></div>
                <div className="photo"><img src="https://img.freepik.com/fotos-premium/onda-suave-na-praia-de-areia_28668-189.jpg?w=2000" width={300} height={300}/></div>
                <div className="photo"><img src="https://img.freepik.com/fotos-gratis/floresta-do-outono_1182-869.jpg?w=2000" width={300} height={300}/></div>
